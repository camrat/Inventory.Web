...
angular
    .module('theme.tables-ng-templatestepgrid', [])
    .controller('TablesTemplateStepsController', ['$scope', '$filter', '$http','$modal', function ($scope, $filter, $http, $modal) {
        $scope.filterOptions = {
            filterText: "",
...
/**
 * Created by wilsond on 11/29/2014.
 */
